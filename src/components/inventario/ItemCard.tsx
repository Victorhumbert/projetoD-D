...
/**
 * Card de item do inventário com toggle de equipado e ações de editar/remover.
 */
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          'mt-0.5 h-5 w-5 rounded-full border-2 flex-shrink-0 transition-all',
          item.equipado
      ...
      <div className="flex gap-1 flex-shrink-0">
        ...
        <Button
          ...
          onClick={() => {
            if (
              window.confirm(`Remover "${item.nome}" do inventário?`)
            )
              removeItem(item.id);
          }}
